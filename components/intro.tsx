    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="https://drive.google.com/uc?export=view&id=17XPaRkGTnvH4qOIOdNEs-Y6UhvQPaNdk"
              alt="My potrait"
              width="192"
              height="192"
              quality="95"
      ...
      >
        <span className="font-bold">
          {" "}
          Hello, I'm Devi Aditya Varma Dantuluri.
        </span>{" "}
        ...
        <span className="italic">
          scalable web applications, deploying ML models, and optimizing
        ...
        <span className="underline">
          {" "}
          ML model deployment and backend optimization
        </span>
        .
      </motion.h1>
